    ...
    <MDBRow className="mb-4">
        ...
        <MDBCard className="cascading-admin-card">
          ...
          <MDBCardBody>
            <div className="progress">
              <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" className="progress-bar bg-primary"
                   role="progressbar"
                   style={{width: '25%'}}></div>
            </div>
      ...
      <MDBCol xl="3" md="6" className="mb-r">
        <MDBCard className="cascading-admin-card">
          ...
          <MDBCardBody>
            <div className="progress">
              <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" className="progress-bar bg grey"
                   role="progressbar"
                   style={{width: '25%'}}></div>
            </div>
      ...
      <MDBCol xl="3" md="6" className="mb-r">
        <MDBCard className="cascading-admin-card">
          ...
          <MDBCardBody>
            <div className="progress">
              <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" className="progress-bar grey darken-2"
                   role="progressbar"
                   style={{width: '75%'}}></div>
            </div>
