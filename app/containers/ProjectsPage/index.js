...
import { MDBCard, MDBCol, MDBRow, MDBView, MDBMask, MDBCardBody, MDBCardTitle, MDBCardText, MDBCardFooter, MDBBtn, MDBIcon } from 'mdbreact';
        ...
        <MDBCol>
          <section className="text-center pb-3">
            <MDBRow className="d-flex justify-content-center">
              <MDBCol sm="6" lg="4" xl="3" className="mb-3">
